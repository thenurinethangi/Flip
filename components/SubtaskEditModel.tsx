...
export default function SubtaskEditModal({
    ...
    const isPastDate = taskDate ? !isNotPastDate(taskDate) : false;
    const taskStatus = taskForm.status;
                        ...
                        >
                                    ...
                                    <View className='flex-row items-center gap-x-[14px]'>
                                        <View
                                            ...
                                            style={{
                                                ...
                                                borderRadius: 5,
                                                borderWidth: 1.5,
                                                borderColor: taskStatus !== "pending" ? statusColor : priorityColorMap[taskForm.priorityLevel],
                                                alignItems: "center",
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                color={taskStatus !== "pending" ? statusColor : "transparent"}
                                        ...
                                        <View className="gap-y-[3px]">
                                            <View className="flex-row gap-x-[5px]">
                                                <Text
                                                    ...
                                                    style={{ color: taskDate ? statusColor : textPrimary }}
                                                >
                                                    {headerDate}
                                                    {taskForm.time != "None" ? "," : ""}{" "}
                                                    {taskForm.time != "None" ? taskForm.time : ""}
                                                </Text>
                                                {taskForm.reminder !== 'None' ? <AlarmClock color={taskDate ? statusColor : textPrimary} size={17} strokeWidth={1.7}></AlarmClock> : ''}
                                            </View>
                            ...
                            <ScrollView
                                ...
                                contentContainerStyle={{
                                    paddingBottom: 140 + (Platform.OS === "android" ? keyboardHeight : 0),
                                }}
    ...
    `,
                            ...
                            >
                                <View className='flex-1 items-center justify-center bg-black/40 px-6'>
                                    <View className='w-full rounded-3xl px-6 pt-7 pb-6' style={{ backgroundColor: isDark ? '#1E1E1E' : '#ffffff' }}>
